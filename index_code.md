...
Everything here is safe and tested.

---

## 🧩 Step 1: Open the CurseForge App
*Let's open CurseForge to download and manage the modpack.*
...
*Now we'll add Mint's Merry Realms Modpack to your app.*
...
6. If this is the first time you've joined the server, or if changes have been made to the server since you last played, you'll see a message saying:
   ...
   - **Click "Yes, close the game"**. After that, re-launch the game as you did in Step 3, click **Multiplayer** again, and join Mint's Merry Realm from the server list. **Sometimes you'll need to do another mod update** - that's fine and totally normal.
